...
// CODE BELOW WAS FUNCTIONAL
function bonAppetit(bill, k, b) {
  // Write your code here
  // remove k index from bill array
  // add integers in new bill array
  // divide by 2
  // compare to b
  // return appropriate output
  bill.splice(k, 1);

  let annaTotal = bill.reduce((a, b) => a + b, 0) / 2;
  if (annaTotal == b) {
    console.log("Bon Appetit");
  } else {
    console.log(b - bill.reduce((a, b) => a + b, 0) / 2);
  }
}
